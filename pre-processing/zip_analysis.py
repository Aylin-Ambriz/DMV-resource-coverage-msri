...
class DMVCensusTractMapper:
    def __init__(self):
        ...
        self.output_file = "pre-processing/output/dmv_census_tracts.html"
        self.tract_analysis_file = "pre-processing/data/dmv_census_tract_analysis.json"
        self.static_image_file = "pre-processing/output/dmv_census_tracts_map.png"
        self.census_tracts_file = "pre-processing/data/zip_data/zip_poly.shp"
    ...
    def process_census_tracts(self, tracts_gdf, offices: List[Dict]):
        ...
        for idx, tract in tracts_gdf.iterrows():
            try:
                ...
                tract_id = tract.get('ZIP_CODE', f'zip_{idx}')
                tract_name = tract.get('PONAME', f'PONAME {idx}')
